...
class TranscriptStorage:
    ...
    def save_raw_transcript(self, filename: str, content: str) -> str:
        """保存原始转录文本
        ...
        Returns:
            保存的文件路径
        """
        return self._save_transcript(filename, content, "raw")
    
    def save_anonymized_transcript(self, filename: str, content: str) -> str:
        """保存匿名化转录文本
        ...
        Returns:
            保存的文件路径
        """
        return self._save_transcript(filename, content, "anonymized")
    
    def save_processed_transcript(self, filename: str, content: str) -> str:
        """保存处理后的转录文本
        ...
        Returns:
            保存的文件路径
        """
        return self._save_transcript(filename, content, "processed")
    
    def _save_transcript(self, filename: str, content: str, suffix: str) -> str:
        """内部方法：保存转录文本
    ...
    def load_transcript(self, filename: str, suffix: str = "raw") -> Optional[str]:
        """加载转录文本
